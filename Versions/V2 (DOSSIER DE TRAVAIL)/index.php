...
<!-------------Header----------------->
    ...
    <div class="swiper-wrapper">
      <!--<div class="swiper-slide" style="background: url(./media/caissesavon.jpg) center/cover;"></div>-->
      ...
      <div class="swiper-slide"><video src="./image/video.mp4" id="video" autoplay loop muted></video></div>
    </div>
