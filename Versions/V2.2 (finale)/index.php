...
<head>
    ...
    <meta name="description" content="Bienvenue dans la Course du Roi, un évènement inédit de caisse à savon au Puy-en-Velay. Au programme ? Des courses pour petits et grands, défilé, tout ceci sur trois jours, et surtout, tout ça dans un style renaissance, pour être au cœur des temps immuables du Puy-en-Velay.">
...
<!-- -----------------Debut EvenementInedit-------------- -->
    <h1>Un Evenement Inedit</h1>
        ...
        <div class="contenaireV">
            <iframe class="video" width="720" height="423" src="https://www.youtube.com/embed/VwbxOu8_yRc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
        </div>
    <section id="contenu" class="para-image">
            <div class="paragraphe">
                <p>Lors de la troisième semaine de Juin, la ville du Puy-en-Velay replongera, le temps d'une fin de semaine, dans le XVI<sup>ème</sup> siècle si caractéristique des fêtes Renaissance du Roi de l'Oiseau.</p>
            </div>
            <div class="container">
    ...
    <section id="contenu" class="para-image3">
        <div class="paragraphe">
            <p>Les festivités débuteront vendredi soir, avec un défilé des participants, leurs caisses à savon et les couleurs qu'ils représentent.
                Il est évidemment possible de concourir sous bannière personnelle ou neutre, tant que le thème est respecté.
...
<!-- ------Debut Epreuves ------------>
    ...
    <section class="epreuve-container">
        <div class="paragraphe">
            <p>Les épreuves sont au nombre de trois : deux pour les adultes (18 ans et plus) et une pour les enfants (14 - 17 ans).
            </p>
        </div>
        <div class="button-container">
