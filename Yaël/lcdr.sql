...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 27 oct. 2022 à 16:55
...
INSERT INTO `parcours` (`nomParcours`, `distanceMetres`, `depart`, `arrivee`, `description`, `image`) VALUES
(' La voie sacrée', 500, 'Cathédrale du Puy', ' Église Saint Laurent', ' Au cœur de la vieille ville des Ponots et de sa cathédrale, les participants feront ici une course très compliquée, dans les rues pavées du Puy-en-Velay, il faudra des roues et un châssis solide si des coureurs veulent sortir du lot et tenter de remporter cette épreuve', 'image/Circuit-2-C-E'),
('La route du Sacre', 1500, ' Hauteurs d’Espaly-Saint-Marcel', 'Église Saint Laurent ', 'Ce circuit de la grande finale est un défi totalement différent de celui de la veille, en effet les participants auront plus de virages à négocier et devront réussir à garder toute leur vitesse pour réussir à franchir la grande ligne droite du Boulevard Gambetta pour enfin finir dans la grande descente du Boulevard Saint-Louis', 'image/Circuit-1-E-P');
